...
const WellbingTips2 = () => {
  ...
  const onNextPress = () => {
    ...
    navigation.navigate("WellbingTips3");
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.answerText}>
          2. Be in the present: Being in the present moment and noticing our own
          thoughts, feelings, and surroundings can help us gain a better
          perspective of ourselves and the world.
        </Text>
      </View>
