...
const WellbingTips1 = () => {
  ...
  const onNextPress = () => {
    ...
    navigation.navigate("WellbingTips2");
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.answerText}>
          1. Re-frame unhelpful thoughts: Our thoughts, feelings, and actions
          are connected. Sometimes, we may have unhelpful patterns of thinking
          or behaving that affect our mental health and well-being. We can
          improve how we feel by recognizing and changing these patterns.
        </Text>
      </View>
