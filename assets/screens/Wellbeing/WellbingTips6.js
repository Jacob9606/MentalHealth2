    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.answerText}>
          6. Do something for yourself: Doing things that bring you joy, such as
          relaxing, learning something new, or pursuing a hobby, is important
          for your happiness. You can also try something different and acquire a
          new skill.
        </Text>
      </View>
