...
const WellbingTips3 = () => {
  ...
  const onNextPress = () => {
    ...
    navigation.navigate("WellbingTips4");
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.answerText}>
          3. Get good sleep: Getting enough sleep is important because it
          greatly affects our mental and physical well-being.
        </Text>
      </View>
