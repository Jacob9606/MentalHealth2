...
const WellbingTipsConcept = () => {
  const navigation = useNavigation();

  const onNextPress = () => {
    // Navigation logic to go to the next FAQ
    navigation.navigate("WellbingTips1");
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.questionText}>
          Top tips to improve your mental health and well-being.
        </Text>
        <Text style={styles.answerText}>
          • Good mental health and well-being are vital for living happy and
          healthy lives. Here are 7 simple ways to make a big difference in your
          well-being. Why not give them a try today?
        </Text>
      </View>
...
export default WellbingTipsConcept;
