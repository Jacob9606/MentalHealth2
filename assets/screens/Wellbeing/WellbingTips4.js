...
const WellbingTips4 = () => {
  ...
  const onNextPress = () => {
    ...
    navigation.navigate("WellbingTips5");
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.answerText}>
          4. Connect with others: Connecting with others, sharing our feelings,
          and helping others can prevent us from feeling lonely and boost our
          mental health and well-being. We can do this online, by phone, or in
          person.
        </Text>
      </View>
