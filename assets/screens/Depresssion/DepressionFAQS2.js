    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.questionText}>
          FAQ: What are the treatments of Depression?
        </Text>
        <Text style={styles.answerText}>
          • The right treatment and duration of treatment for you will depend on
          the type of depression you have and how severe.
        </Text>
        <Text style={styles.answerText}>
      ...
      <View style={styles.iconContainer}>
        <TouchableOpacity onPress={() => navigation.navigate("DepressionFAQ1")}>
...
export default DepressionFAQS2;
