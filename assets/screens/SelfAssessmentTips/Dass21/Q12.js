    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.question}>
          12. I was unable to become enthusiastic about anything.
        </Text>
