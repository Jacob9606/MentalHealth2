  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.questionText}>How does stress affect us?</Text>
        <Text style={styles.answerText}>
          • Stress affects both the mind and the body. Too much stress can cause
          physical and mental health problems. Learning how to cope with stress
          can help us feel less overwhelmed and support our mental and physical
          well-being.
        </Text>
        <Text style={styles.questionText}>Sucide</Text>
        <Text style={styles.answerText}>
          • Stress affects both the mind and the body. Too much stress can cause
          physical and mental health problems. Learning how to cope with stress
          can help us feel less overwhelmed and support our mental and physical
...
export default PsychologicalFAQS1;
